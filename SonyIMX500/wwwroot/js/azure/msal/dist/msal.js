...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var StringUtils_1 = __webpack_require__(454);
var version_json_1 = __webpack_require__(641);
var LogLevel;
(function (LogLevel) {
...
var Logger = /** @class */ (function () {
    ...
    Logger.prototype.logMessage = function (logLevel, logMessage, containsPii) {
        ...
        if (!StringUtils_1.StringUtils.isEmpty(this.correlationId)) {
            log = timestamp + ":" + this.correlationId + "-" + version_json_1.version + "-" + LogLevel[logLevel] + (containsPii ? "-pii" : "") + " " + logMessage;
        }
        else {
            log = timestamp + ":" + version_json_1.version + "-" + LogLevel[logLevel] + (containsPii ? "-pii" : "") + " " + logMessage;
        }
...
var ServerRequestParameters = /** @class */ (function () {
    ...
    function ServerRequestParameters(authority, clientId, responseType, redirectUri, scopes, state, correlationId) {
        ...
        this.xClientVer = version_json_1.name;
...
var TelemetryManager = /** @class */ (function () {
    function TelemetryManager(config, telemetryEmitter, logger) {
        ...
        this.telemetryPlatform = tslib_1.__assign({ sdk: Constants_1.Constants.libraryName, sdkVersion: version_json_1.version, networkInformation: {
                // @ts-ignore
...
module.exports = JSON.parse("{\"name\":\"msal\",\"version\":\"1.4.5\"}");
